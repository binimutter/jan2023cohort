...
// console.log is how we will view our js before we have front end
...
// console.log('line #9 aString:',aString)
...
// 1. create a for loop - i starts at 0 goes to and include 10 increase by 2 each time
// 2. print each value of i
...
// 1. create for loop
// 2. start at 0
// 3. end at end of array cities.length will equal 4
...
// while loops need a conditional to know when to end
...
// Loop #3 - print Seattle if - else if
// Loop #4 - print Orlando if - else

// === means match data type string for string int for int
// == means are they equal can cross data types EXCEPT booleans
